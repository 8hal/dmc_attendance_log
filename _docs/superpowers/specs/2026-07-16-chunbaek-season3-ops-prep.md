...
| **대회** | **2026-11-01** | 일 | **2026 JTBC 서울마라톤** (100일 종료 5일 후) |
...
> 100일 프로그램은 **7/20~10/27**. 대회(11/1)는 슬롯 밖 — 종료 후 5일 뒤.  
> 10/25(일)은 **98일차** 훈련일로 슬롯에 포함됨.
...
| 2026-07-16 | 시작일 7/20, 대회 **11/1 JTBC 서울마라톤** 반영 |
