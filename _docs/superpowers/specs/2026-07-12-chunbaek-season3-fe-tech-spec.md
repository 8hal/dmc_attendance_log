...
| **내 100일 훈련** | 제목 한 줄 | **제목+내용 2줄**, 탭→상세 모달 (**B 확정**). 홈 주간 카드(A)는 선택·보류 |
...
## 10b. 확정 결정 (2026-07-12)

| 항목 | 결정 |
|------|------|
| 명단 | `participant: true` **운영진 사전 지정**, 시즌 중 추가 가능 |
| 토요 연동 | **자동 연동 없음** — 홈에 「동마클+춘백 둘 다 출석」 안내 |
...
| 2026-07-12 | 토요 홈 안내: 동마클+춘백 각각 출석 |
| 2026-07-12 | 명단: participant 사전 지정, 시즌 중 추가 |
